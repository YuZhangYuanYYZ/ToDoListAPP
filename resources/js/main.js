...
function completeItem() {
  ...
  //console.log(`8:item is ${item},parent is ${parent},id is ${id},value is ${value}`)
  if (id === 'todo') {
...
function addItemToDOM(text, completed) {
  ...
  buttonElements.appendChild(removeButton);
  buttonElements.appendChild(completeButton);
  item.appendChild(buttonElements);
